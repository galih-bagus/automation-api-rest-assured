...
//        RestAssured.baseURI = baseUri;
    ...
    public void getListProject() {
        ...
        Response response = OtherUtils.responseGet("project", token, 200, "project-schema/project-schema.json");
    ...
    public void createProject() {
        ...
        Response response = OtherUtils.responsePost("project", token, body, 201, "project-schema/create-project-schema.json");
        String data = response.asString();
        String message = response.jsonPath().getString("message");
    ...
    public void searchProject() {
        String token = AuthUtils.login();
        Response response = OtherUtils.responseGet("project?filter[title]=" + this.createdProjectTitle, token, 200, "project-schema/project-schema.json");
        String data = response.asString();
        String message = response.jsonPath().getString("message");
    ...
    public void getDetailProject() {
        String token = AuthUtils.login();
        Response response = OtherUtils.responseGet("project/" + this.createdProjectId, token, 200, "project-schema/detail-project-schema.json");
        String data = response.asString();
        String message = response.jsonPath().getString("message");
    ...
    public void updateProject() {
        ...
        String body = requestBody.toString();
        Response response = OtherUtils.responsePost("project/" + this.createdProjectId, token, body, 200, "project-schema/create-project-schema.json");
        String id = response.jsonPath().getString("data.id");
        String message = response.jsonPath().getString("message");
        String createdProjectTitleData = response.jsonPath().getString("data.title");
        String createdProjectIdData = response.jsonPath().getString("data.id");
    ...
    public void deleteProject() {
        String token = AuthUtils.login();
        Response response = OtherUtils.responseDelete("project/" + this.createdProjectId, token, 200, "project-schema/delete-project-schema.json");
        String data = response.asString();
        String message = response.jsonPath().getString("message");
